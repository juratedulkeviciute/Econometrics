...
D
```
Čia pasirenkame du atsitiktinius skaičius iš intervalo $[0,1]$. Tada pritaikome formulę:$(1 -  \sqrt{x_1}) \cdot A + (\sqrt{x_1} \cdot (1 - y_1)) \cdot B + (\sqrt{x_1} \cdot y_1) \cdot C)$ , kuri yra skirta apskaičiuoti tašką, kuris bus trikampio viduje.
