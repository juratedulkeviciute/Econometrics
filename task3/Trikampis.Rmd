...
D
```
Čia pasirenkame du atsitiktinius skaičius iš intervalo $[0,1]$. Tada pritaikome formulę: $(1 - sqrt(x1)) * A + (sqrt(x1) * (1 - y1)) * B + (sqrt(x1) * y1) * C)$ , kuri yra skirta apskaičiuoti tašką, kuris bus trikampio viduje.
